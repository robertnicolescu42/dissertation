...
export class OeeCalculationComponent implements OnInit {
  ...
  workstation: Workstation = {
    stationId: '',
    displayName: '',
    isConsiderScrapForOee: false,
    equipmentNumber: '',
    isOeeCalculable: false,
    isSendingQualityRate: false,
    cycleTime: 0,
    cycleTimeDelay: 0,
    description: '',
    plantIndex: '',
    isStatusSynthetical: false,
    isUsingQmetric: false,
    isPredictiveMaintenanceDisplayed: false,
    isStationMonitorDisplayed: false,
    isProcessTimesDisplayed: false,
    isShowStatusOnly: false,
    stationMonitorYellow: 0,
    stationMonitorRed: 0,
    runningTime: 0,
    productionCount: 0,
    defectCount: 0,
